import os
opencvFlag = 'darknet'##keras,opencv,darknet
...
pwd = os.path.abspath(os.path.join("text_recognition", "ocr_module", "chinese_ocr"))
# pwd = os.path.abspath("/home/c11tch/workspace/PycharmProjects/JC_Demo/ocr_module/chinese_ocr")
