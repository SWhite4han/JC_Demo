...
from text_recognition.ocr_module.chinese_ocr.crnn.crnn import crnnOcr as crnnOcr
from text_recognition.ocr_module.chinese_ocr.apphelper.image import rotate_cut_img, xy_rotate_box, solve
