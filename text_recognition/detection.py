...
import numpy as np
from text_recognition import craft_utils
from text_recognition import imgproc
from text_recognition import file_utils
import json
import zipfile

from text_recognition.craft import CRAFT
...
class Detection:
    ...
    def predict(self, image):
        ...
        # Post-processing
        boxes, polys = craft_utils.getDetBoxes(score_text, score_link, self.args.text_threshold, self.args.link_threshold, self.args.low_text, self.args.poly)
...
if __name__=='__main__':
    ...
    result_folder = './result/detection/'
    ...
    for k, image_path in enumerate(image_list):
        ...
        bboxes, polys, score_text = net.predict(image, args)
