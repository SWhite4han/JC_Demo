...
class InfinitySearch:
    ...
    def count(self):
        response = self.elasticsearch.count(index='infinity')
        response = pprint.pformat(response)
        return response
        """
    ...
    def load_data(self, json_file):
        ...
        with open(json_file) as f:
            data = json.load(f)
        self.elasticsearch.index(index='infinity', doc_type='image_vector', body=data)

    def push_data(self, data):
        self.elasticsearch.index(index='infinity', doc_type='image_vector', body=data)

    def delete_all(self):
        response = self.elasticsearch.indices.delete(index='infinity')
        return response
        """
    ...
    def query_result(self, json_file):
        """
        ...
        response = self.elasticsearch.search(index='infinity', doc_type='image_vector', body=json_query)

        pprint.pprint(response)

        return response['hits']['hits']

    def search_result(self, field, search_text):
        json_query = json.dumps(
            {
                "_source": ["imgPath", "category"],
    ...
    def update_fields(self, id_no, field, new_text):
        ...
        response = self.elasticsearch.update(index='infinity', doc_type='image_vector', id=id_no, body=json_update)
